...
<!-- all the stuff you need for 3D Secure. -->
  <h3>Notes on 3D Secure Parameters</h3>
    ...
    <p>Currently, the <span style="background-color: #E6E6E6;font-weight: bold;">amount</span> passed when authenticating a card with 3D Secure must be a non-zero value. This may change in the future, but for the time being, it would be best to ensute that the credit card verification amount is also non-zero.</p>
